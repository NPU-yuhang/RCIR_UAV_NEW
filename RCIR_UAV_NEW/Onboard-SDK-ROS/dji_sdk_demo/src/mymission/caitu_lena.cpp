...
std::string ss;
std::string s1 = "/media/nvidia/SD/flyvideo/images/";
std::string s2 = ".jpg";
...
int main(int argc, char **argv)
{
  ...
  writer.open("/media/nvidia/SD/flyvideo/VideoTest_lena.avi", CV_FOURCC('F', 'L', 'V', '1'), 18, cv::Size(800, 600), true);
  if (!writer.isOpened())
  {
